...
export default function ProductDetailsCarousel({ product }) {
  ...
  const imagesLightbox = product.map((_image) => _image);
    ...
    <RootStyle>
      ...
      <Box
        sx={{
          ...
          ...(product.length === 1 && { maxWidth: THUMB_SIZE * 1 + 16 }),
          ...(product.length === 2 && { maxWidth: THUMB_SIZE * 2 + 32 }),
          ...(product.length === 3 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(product.length === 4 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(product.length >= 5 && { maxWidth: THUMB_SIZE * 6 }),
          ...(product.length > 2 && {
            position: 'relative',
            '&:before, &:after': {
              top: 0,
